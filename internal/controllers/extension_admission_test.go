...
// func TestExtensionAdmissionServiceAccount(t *testing.T) {
...
// 		{"long channel name", fmt.Sprintf("longname%s", strings.Repeat("0", 256)), tooLongError},
...
// 			}))
// 			if tc.errMsg == "" {
// 				require.NoError(t, err, "unexpected error for serviceaccount %q: %w", tc.saName, err)
// 			} else {
// 				require.Error(t, err)
...
// func TestExtensionAdmissionSource(t *testing.T) {
// 	testCases := []struct {
// 		name   string
// 		source ocv1alpha1.ExtensionSource
// 		err    string
...
// 			}))
// 			if tc.err == "" {
// 				require.NoError(t, err, "unexpected error for spec.source %v: %w", tc.source, err)
// 			} else {
// 				require.Error(t, err)
...
// func TestExtensionAdmissionSourcePackageName(t *testing.T) {
// 	tooLongError := "spec.source.package.name: Too long: may not be longer than 48"
// 	regexMismatchError := "spec.source.package.name in body should match"
...
// 	}
// }
// func TestExtensionAdmissionSourcePackageVersion(t *testing.T) {
// 	tooLongError := "spec.source.package.version: Too long: may not be longer than 64"
// 	regexMismatchError := "spec.source.package.version in body should match"
...
// func TestExtensionAdmissionSourcePackageChannel(t *testing.T) {
// 	tooLongError := "spec.source.package.channel: Too long: may not be longer than 48"
// 	regexMismatchError := "spec.source.package.channel in body should match"
...
// func buildExtension(spec ocv1alpha1.ExtensionSpec) *ocv1alpha1.Extension {
// 	return &ocv1alpha1.Extension{
